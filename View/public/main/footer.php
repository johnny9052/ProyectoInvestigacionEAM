<footer class="page-footer bannerColorGris">
    <div class="container">
        <div class="row">
    ...
    <div class="footer-copyright azulOscuroEAM">
        <div class="container">
            Desarrollado por <a class="orange-text text-lighten-3">Ms. Johnny Alexander Salazar Cardona</a>
            y <a class="orange-text text-lighten-3">Ms. David Alberto Angaria Garcia</a>
