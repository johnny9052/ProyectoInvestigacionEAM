...
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
        <br><br>
        <h1 class="header center textoAzul">¿Como iniciar?</h1>
        <div class="row center">
            <h5 class="header col s12 light">Analisis de datos web EAM para la toma de decisiones</h5>
        </div>
        <div class="row center">
            <a href="http://materializecss.com/getting-started.html" id="download-button" 
               class="btn-large waves-effect waves-light grisEAM">Tutorial</a>
        </div>        
        ...
        <div class="row">
            <div class="col s12 m4">
                <div class="icon-block">
                    ...
                    <h5 class="center">Analisis rapidos</h5>
        ...
        <div class="row">
            <div class="col s12 m4">
                <div class="icon-block">
                    ...
                    <p class="light justifyText">
                        Analiza datos a profundidad aplicando analitica visual para descubrir conocimiento oculto en los datos. 
                    </p>
                </div>
            </div>
            ...
            <div class="col s12 m4">
                <div class="icon-block">
                    ...
                    <p class="light justifyText">
                        Utiliza los graficos interactivos e indicadores claves de rendimiento para cruzar informacion y ver el estado de estos.  
                    </p>
                </div>
            </div>
            ...
            <div class="col s12 m4">
                <div class="icon-block">
                    ...
                    <p class="light justifyText">
                        Encuentra patrones que ayuden a la toma de decisiones y por ende, el mejoramiento permanente de la Institucion Universitaria EAM. 
                    </p>
                </div>
            </div>
        </div>
