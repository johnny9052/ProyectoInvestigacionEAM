...
<div class="row">
    <div class="col s12">
        <ul class="tabs tabs-fixed-width">
            ...
            <li class="tab col s3"><a  href="#test2">Jornada - nivel - semestre</a></li>
            <li class="tab col s3"><a href="#test3">Espacio academico</a></li>
            <li class="tab col s3"><a href="#test4">Estrato social o discapacidad</a></li>
            <li class="tab col s3"><a href="#test5">nucleo familiar</a></li>
            <li class="tab col s3"><a href="#test6">situacion laboral</a></li>
        </ul>
    </div>
    <div id="test1" class="col s12">
        <iframe width="100%" height="800" src="https://app.powerbi.com/view?r=eyJrIjoiY2FjMjkyYjctZWExMC00MzNkLTk0MzAtNzc1YzlmYWI4ZmQ2IiwidCI6IjVjZDI2YTJmLTE1NTAtNDk3ZS1iZDYzLTcxNDFjNzQ2OTg1YiIsImMiOjR9" frameborder="0" allowFullScreen="true"></iframe>
    </div>
